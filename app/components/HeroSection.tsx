...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      <Image
        src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=1920&q=80&fit=crop"
        alt="The Gilded Page bookstore"
        fill
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/books"
            className="inline-flex items-center justify-center px-8 py-4 bg-accent-600 text-white rounded-sm hover:bg-accent-500 transition-colors font-semibold text-lg tracking-wide"
          >
            Browse Books
          </Link>
          <Link
